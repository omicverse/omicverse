...
class BaseMiner(ModuleWithRecordsAndDistance):
    def mine(self, embeddings, labels, ref_emb, ref_labels, species, mnn, setting):
        raise NotImplementedError

    def output_assertion(self, output):
        raise NotImplementedError

    def forward(self, embeddings, labels, species, ref_emb=None, ref_labels=None, mnn=True):
        """
        Args:
        ...
        with torch.no_grad():
            ...
            c_f.assert_embeddings_and_labels_are_same_size(embeddings, species)
