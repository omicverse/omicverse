...
_LAZY_ATTRS: dict[str, tuple[str, str]] = {
    ...
    "DIFFUSION_LIMIT":       ("._kinetics", "DIFFUSION_LIMIT"),
    ...
    "SynthesisIssue":        ("._harmonize", "SynthesisIssue"),
    "HOSTS":                 ("._harmonize", "HOSTS"),
    ...
    "CrossReaction":         ("._fidelity", "CrossReaction"),
    ...
    "CompiledGate":          ("._compile", "CompiledGate"),
    ...
    "Gene":                  ("._circuit", "Gene"),
    "Regulation":            ("._circuit", "Regulation"),
    "constitutive":          ("._circuit", "constitutive"),
    ...
    "ensure_lineardesign":   ("._mrna", "ensure_lineardesign"),
    ...
    "Guide":                 ("._crispr", "Guide"),
    "OffTarget":             ("._crispr", "OffTarget"),
    "ENZYMES":               ("._crispr", "ENZYMES"),
    ...
    "AssemblyResult":        ("._assembly", "AssemblyResult"),
    ...
    "DegenerateCodon":       ("._library", "DegenerateCodon"),
    "DesignedVariant":       ("._library", "DesignedVariant"),
    ...
    "DECISIONS":             ("._biosecurity", "DECISIONS"),
    # ---- Build layer: designs into executable instructions -----------------
    "plate_layout":          ("._build", "plate_layout"),
    "Plate":                 ("._build", "Plate"),
    "well_name":             ("._build", "well_name"),
    "parse_well":            ("._build", "parse_well"),
    ...
    "ECHO_COLUMNS":          ("._build", "ECHO_COLUMNS"),
    ...
    "ACQUISITIONS":          ("._dbtl", "ACQUISITIONS"),
    # ---- tuning a construct rather than just building one ------------------
    "tai":                   ("._tuning", "tai"),
    "TAIResult":             ("._tuning", "TAIResult"),
    "TRNA_COPY_NUMBERS":     ("._tuning", "TRNA_COPY_NUMBERS"),
    "ECOLI_TRNA_TOTALS":     ("._tuning", "ECOLI_TRNA_TOTALS"),
    "ECOLI_OPTIMAL_CODONS":  ("._tuning", "ECOLI_OPTIMAL_CODONS"),
    "check_trna_table":      ("._tuning", "check_trna_table"),
    ...
    "check_integration_sites": ("._tuning", "check_integration_sites"),
    "replichore_fraction":   ("._tuning", "replichore_fraction"),
    "ORIC_POSITION":         ("._tuning", "ORIC_POSITION"),
    "TERC_POSITION":         ("._tuning", "TERC_POSITION"),
    "GENOME_LENGTH":         ("._tuning", "GENOME_LENGTH"),
